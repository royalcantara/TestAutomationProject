package com.paymentgateway.uat.quest.domainz.testcases;
...
public class SalesDBJourneyTest extends TestBase{
		...
		public void QuestDomainz_VerifyCreateOrderPaidViaCreditCardInSalesDB(String environment) throws InterruptedException{
		...
		Date d1 = new Date();
		strDomainName_01 = "testpgquestdomainz" + df.format(d1);

		if (environment.equals("uat2")) {
			strAccountReference = "570-00";
			strTld_01 = "com";
			strRegistrationPeriod = "2 x Y NZ$105.78[ NZ$0 setup]";
		...
		public void QuestDomainz_VerifyCreateOrderPaidViaInvoiceInSalesDB(String environment) throws InterruptedException{
		...
		if (environment.equals("uat2")) {
			...
			strProductPeriod = "1 x M NZ$14.95[ NZ$0 setup]";
