package com.paymentgateway.uat.quest.dps.testcases;
...
public class SalesDBJourneyTest extends TestBase{
		...
		Date d1 = new Date();
		strDomainName_01 = "testpgquestdps" + df.format(d1);

		if (environment.equals("uat2")) {
			strAccountReference = "COL-1473";
			strTld_01 = "com";
		...
		public void QuestDPS_VerifyCreateOrderPaidViaInvoiceInSalesDB(String environment) throws InterruptedException{
