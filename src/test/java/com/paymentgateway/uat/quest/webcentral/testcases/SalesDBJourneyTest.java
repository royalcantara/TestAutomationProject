package com.paymentgateway.uat.quest.webcentral.testcases;
...
public class SalesDBJourneyTest extends TestBase{
		...
		public void QuestWebCentral_VerifyCreateOrderPaidViaCreditCardInSalesDB(String environment) throws InterruptedException{
		...
		Date d1 = new Date();
		strDomainName_01 = "testpgquestwebcentral" + df.format(d1);

		if (environment.equals("uat2")) {
			strAccountReference = "570-04";
			strTld_01 = "com";
			strRegistrationPeriod = "1 x Y AU$19.95[ AU$0 setup]";
			strMajorProduct = "Done For You Website - cPanel";
			strProductPeriod = "1 x M AU$99[ AU$149 setup]";
			strPaymentMethod = "MasterCard: 5555xxxxxxxx1111 01/20";
...
//		driver.close();
		...
		public void QuestWebCentral_VerifyCreateOrderPaidViaInvoiceInSalesDB(String environment) throws InterruptedException{
