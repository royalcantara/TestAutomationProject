package com.paymentgateway.uat.quest.netregistry.testcases;
...
public class SalesDBJourneyTest extends TestBase{
		...
		public void QuestNetregistry_VerifyCreateOrderPaidViaCreditCardInSalesDB(String environment) throws InterruptedException{
		...
		Date d1 = new Date();
		strDomainName_01 = "testpgquestnetregistry" + df.format(d1);

		if (environment.equals("uat2")) {
			strAccountReference = "570-01";
			strTld_01 = "com";
			strRegistrationPeriod = "2 x Y AU$43.9[ AU$0 setup]";
		...
		public void QuestNetregistry_VerifyCreateOrderPaidViaInvoiceInSalesDB(String environment) throws InterruptedException{
		...
		if (environment.equals("uat2")) {
			strAccountReference = "570-01";
			strTld_01 = "com";
			strRegistrationPeriod = "1 x Y AU$21.95[ AU$0 setup]";
			strMajorProduct = "Basic cPanel Hosting";
			strProductPeriod = "1 x M AU$7.95[ AU$0 setup]";
