package com.paymentgateway.uat.quest.melbourneit.testcases;
...
public class SalesDBJourneyTest extends TestBase{
		...
		public void QuestMelbourneIT_VerifyCreateOrderPaidViaCreditCardInSalesDB(String environment) throws InterruptedException{
		...
		Date d1 = new Date();
		strDomainName_01 = "testpgquestmit" + df.format(d1);

		if (environment.equals("uat2")) {
			strAccountReference = "570-02";
			strTld_01 = "com";
			strRegistrationPeriod = "1 x Y AU$79[ AU$0 setup]";
			strMajorProduct = "Basic cPanel Hosting";
			strProductPeriod = "1 x M AU$12.95[ AU$0 setup]";
			strPaymentMethod = "Visa: 4111xxxxxxxx1111 01/19";
		...
		public void QuestMelbourneIT_VerifyCreateOrderPaidViaPrepaidCardInSalesDB(String environment) throws InterruptedException{
